...
import "./TopRatedSimilarMovieDetails.css";

const TopRatedSimilarMovieDetails = () => {
  ...
  const IDNumber = localStorage.getItem("topratedsimilarmovieid");
...
export default TopRatedSimilarMovieDetails;
