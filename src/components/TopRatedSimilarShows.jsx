      ...
      <div>
        ...
        <ul className="similar_horizontal-scroll">
          {similarShowList.map((item) => (
            <li>
              <Link
                to={`/topratedsimilarshow/${item.id}`}
                onClick={() => {
                  localStorage.setItem("topratedsimilarshowid", item.id);
                  localStorage.setItem(
                    "topratedsimilarshowname",
                    item.original_name
                  );
                }}
              >
...
export default TopRatedSimilarShows;
